...
<div class="container"></div>
                <form action="Barber.php?PageName=AddAppointment&clientId=<?php echo $_GET["clientId"]; ?>" method="post" class="">
                <div class="row ">
...
<option value="Regular Hair Cut">Regular Hair Cut - 50</option>
<option value="Full Scissor Cut">Full Scissor Cut - 35</option>
<!-- <option value="Beard Shave">Beard Shave - </option> -->
<option value="Beared Trim">Beared Trim - 35</option>
<option value="Full Treatment">Full Treatment - 70</option>
<option value="Full Treatment + Hot Tool Shave">Full Treatment + Hot Tool Shave - 100 </option>
<option value="Hot Tool Shave">Hot Tool Shave - 30</option>
        </select>
    </div>
    <div class="col-lg-2">
       </div>
