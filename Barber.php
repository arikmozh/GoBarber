...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="Barber.php" class="brand-link">
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="Barber.php?PageName=ClientListMessage" class="nav-link">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="Barber.php?PageName=EarningPage" class="nav-link">
                    <p>Income Reports</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="Barber.php?PageName=AppointmentPage" class="nav-link">
            ...
            <li class="nav-item">
              <a href="Barber.php?PageName=Profile" class="nav-link">
                <i class="nav-icon fas fa-users"></i>
                <p>
                  View Profile
                </p>
            ...
            <li class="nav-item">
              <a href="Barber.php?PageName=UpdateProfile" class="nav-link">
