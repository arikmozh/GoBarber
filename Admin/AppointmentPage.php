        ...
        <div class="card-header">
                        <div class="container">
                            <div class="row" align='center'>
                                <div class="col-lg-6">
                                <h3>Yearly </h3>
                                            <form  action='Admin.php?PageName=AppointmentPage' method='post'>
                        ...
                        <table id="myTable" class="table table-bordered  text-center table-striped bg-dark">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class='h5'><?php echo getMonthlyAppAdmin();?></th>
                                        <th colspan='2' class='h4'> Yearly  Appointments </th>
                                        <th class='h5'><?php echo getYearlyAppAdmin();?></th>
                                    </tr>
...
if(isset($_POST['year']))
{
    ...
    WHERE client_tb.clientId = appointment_tb.clientId and  appointment_tb.appointmentStatus = 'Active'
